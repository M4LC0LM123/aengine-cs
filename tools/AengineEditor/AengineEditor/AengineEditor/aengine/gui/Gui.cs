...
public class Gui
{
    ...
    public static bool GuiButton(string text, float x, float y, float width, float height, GuiWindow window = null, TextPositioning textPositioning = TextPositioning.CENTER)
    {
        float rx = x;
        float ry = y;
